...
const aiFns = ['renderAI', 'askAI', 'sendAIQuery', 'applyCoachProposal', 'cancelCoachProposal', 'confirmResetSession', 'clearChatHistory'];
aiFns.forEach(fn => {
  console.log(`=== ${fn} ===`);
  console.log(extractFunction(fn).slice(0, 800));
});
