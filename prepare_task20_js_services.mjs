...
(function applyCoachOsI18n(service) {
  const packs = {
    it: {
      ...
      coPrimaryAction: "Azione principale", coAskPlanExecute: "Chiedi. Pianifica. Esegui.",
      coOnlineCoaching: "Coaching online", coSchedule: "Pianifica",
      coScheduleHint: "Chiamata, verifica e revisione.",
      coTodaySubtitle: "Priorità, clienti e prossime azioni in un solo posto.",
      coNoUrgency: "Nessuna urgenza. Il portfolio è sotto controllo.",
      coNoUrgencyWhy: "Nessun cliente richiede un intervento immediato in questo momento.",
      coNoTasks: "I task operativi compariranno qui.", coNoActivity: "Nessuna attività recente.",
      coNoTasksWhy: "Aggiungi un task per tenere traccia di cosa fare.",
      coNoActivityWhy: "Le azioni recenti dei tuoi clienti compariranno qui.",
      coAddTask: "Aggiungi task", coAddClient: "Aggiungi cliente", coImportProgram: "Importa programma",
      coAssignProgram: "Assegna programma", coOpenAndCheck: "Coach OS · apri e controlla",
      coKpiClients: "Clienti", coKpiActive: "Attivi", coKpiUnread: "Non letti", coKpiLive: "Live",
      coComplete: "Completa", coSnooze: "Posticipa 1 giorno", coMoveUp: "Su", coMoveDown: "Giù",
      coOpenClient: "Apri cliente", coClose: "Chiudi", coResolve: "Risolvi", coTask: "Task",
      coAttention: "Attenzione", coLoadingPriorities: "Caricamento priorità…",
      coToastToday: "Coach OS · Oggi", coRequiresAttention: "Richiede attenzione", coActivity: "Attività",
      coAllClients: "Tutti i clienti", coSearchClients: "Cerca clienti…", coSaveView: "Salva vista",
      coLoadMore: "Carica altri", coLoadingClients: "Caricamento clienti…",
      coFilterAll: "Tutti", coFilterActive: "Attivi", coFilterAttention: "Attenzione",
      coFilterInactive: "Inattivi", coFilterUnread: "Non letti", coFilterCheckin: "Verifiche",
      coFilterPayment: "Pagamenti", coFilterProgram: "Programma", coFilterNutrition: "Alimentazione",
      coFilterInjury: "Infortunio",
      coStatusOnTrack: "In linea", coStatusAtRisk: "A rischio", coStatusAwaiting: "In attesa del coach",
      coStatusPayment: "Pagamento dovuto", coNoWorkout: "Nessun allenamento",
      coWorkoutToday: "Allenamento oggi", coWorkoutYesterday: "Allenamento ieri",
      coNextAction: "Prossima azione", coOpen: "Apri", coMessage: "Messaggio",
      coAthleteSnapshot: "Riepilogo atleta", coAthleteIntelligence: "Intelligenza atleta",
      coAthleteBrain: "Cervello atleta", coApprove: "Approva", coModify: "Modifica",
      coDismiss: "Ignora", coAskAgent: "Chiedi all’agente", coOpenData: "Apri dati",
      coTimeline: "Cronologia", coViewAll: "Vedi tutto", coDomains: "Domini",
      coWeight: "Peso", coAdherence: "Aderenza", coTraining: "Allenamento",
      coPerformance: "Prestazione", coLast28d: "Ultimi 28 giorni", coNoProgram: "Nessun programma",
      coTonnageTrend: "Trend tonnellaggio", coGoalUnset: "Obiettivo non impostato",
      coNoTimeline: "Ancora nessuna attività rilevante.", coReviewClient: "Revisiona cliente",
      coSavedAtRisk: "A rischio", coSavedNoWorkout: "Nessun workout 7g",
      ...
      coCreateProgram: "Crea programma", coCreateHint: "Catalogo Nurvan o generazione guidata.",
      coCoachDatabase: "Database coach", coAssign: "Assegna", coWeeks: "settimane",
      coDomainPlan: "Piano per dominio",
      coCalendarSubtitle: "Disponibilità → prenotazione → promemoria → sposta/annulla.",
      coNewSession: "Nuova sessione", coAvailability: "Disponibilità",
      coSessionTypes: "Tipi di sessione", coUpcoming: "Prossime",
      coReschedule: "Sposta", coCancel: "Annulla",
      coNoSessions: "Nessuna sessione in questa vista. Imposta la disponibilità e prenota una chiamata.",
      coNoSessionsWhy: "Non hai sessioni programmate per oggi.",
      coNoAvailability: "Nessuna disponibilità. Imposta gli orari prima di prenotare.",
      coTypeCall: "Chiamata coaching", coTypeCheckIn: "Verifica", coTypeReview: "Revisione",
      coTypeConsult: "Consulenza", coTypeCustom: "Sessione personalizzata", coTypeTraining: "Sessione di allenamento",
      coDay: "Giorno", coWeek: "Settimana", coMonth: "Mese",
      coCheckInsSubtitle: "Richiesti, ricevuti e da revisionare",
      coRequested: "Richiesti", coReceived: "Ricevuti", coToReview: "Da revisionare", coReviewed: "Revisionati",
      coNoCheckIns: "Nessuna verifica in questa coda.", coRequestCheckIn: "Richiedi verifica",
      coAnalyticsSubtitle: "Aderenza, allenamenti e verifiche. Nessun ricavo o MRR qui.",
      coNoRevenue: "Nessun ricavo o MRR qui.", coAtRisk: "A rischio", coWorkouts: "Allenamenti",
      coE1rm: "Campioni e1RM", coVolume: "Volume", coCheckInsDue: "Verifiche in scadenza",
      coClientsToOpen: "Clienti da aprire", coNoAtRisk: "Nessun cliente sotto soglia. Apri Clienti per i dettagli.",
      coBusinessSubtitle: "Nessuno Stripe. Piano, rinnovo e scaduti.",
      coActive: "Attivi", coRevenue30d: "Ricavi 30g", coOverdue: "Scaduti",
      coCrmEmpty: "Nessun cliente in pipeline.",
      coAutomationsSubtitle: "Trigger, condizione, azione. Prova a secco prima di abilitare.",
      coNewRule: "Nuova regola", coDryRun: "Prova a secco", coRun: "Esegui",
      coNoAutomations: "Nessuna automazione. Restano fuori dall’Agente V1.",
      coMealSubtitle: "Foto → Stima → Conferma → Registro. L’AI non salva senza conferma.",
      coMealEstimate: "Stima pasto", coEstimate: "Stima", coConfirmLog: "Conferma e registra",
      coFormSubtitle: "Video → Marker → Feedback → Storico esercizio. Nessuna diagnosi clinica.",
      coSaveMarkers: "Salva marker", coAgentSubtitle: "Intento → Piano → Anteprima → Conferma → Risultato.",
      coAskNurvan: "Chiedi a Nurvan", coConfirm: "Conferma", coUndo: "Annulla",
      coRefreshData: "Aggiorna dati", coReplan: "Ripianifica", coViewData: "Vedi dati",
      coAgentEmpty: "Chiedi un comando: inattivi, verifiche mancanti, deload, messaggio o task.",
      coIntent: "Intento", coPreview: "Anteprima", coResult: "Risultato",
      coWhy: "PERCHÉ",
      coHelpToast: "Guida Coach OS: Oggi → Attenzione → Cliente → Decidi → Esegui",
      coCancel: "Annulla",
      coCoachMode: "Modalità Coach", coClientFallback: "Cliente", coUnread: "non letti",
      coLiveWorkout: "Allenamento live", coClientsUnavailable: "Clienti non disponibili",
      coRetry: "Riprova", coNoClientsView: "Nessun cliente per questa vista.",
      coClientFilter: "Filtro clienti", coDaysAgo: "g fa",
      coLoadingOverview: "Caricamento scheda cliente…", coLoadingOps: "Caricamento operazioni…",
      coOverviewUnavailable: "Scheda non disponibile", coOpenClassic: "Apri workspace classico",
      coBackOverview: "← Scheda cliente", coDeterministic: "Deterministico",
      ...
      coProgramEmpty: "Il database è vuoto. Importa il primo programma scegliendo i domini.",
      coChooseClient: "Scegli il cliente", coAddClientFirst: "Aggiungi prima un cliente.",
      coProgramActions: "Azioni programma", coDuplicate: "Duplica", coExport: "Esporta",
      coArchive: "Archivia", coImportComplete: "Import completato",
      coProgramSaved: "Programma salvato",
      coAssignNow: "è nel database coach. Vuoi assegnarlo ora?",
      coAssignToClient: "Assegna al cliente", coDone: "Fatto",
      coCopySuffix: " · Copia", coArchiveConfirm: "Archiviare questo programma?",
      coLoadingCalendar: "Caricamento calendario…",
      coNoCalendarHint: "Nessun Google/Apple Calendar.",
      coIcal: "iCal", coRule: "Regola", coSessionTitle: "Titolo sessione",
      coSessionType: "Tipo", coStartIso: "Inizio ISO (es. 2026-09-06T09:00:00.000Z)",
      coRecurrenceWeeks: "Ricorrenza settimane (1 = singola)",
      coNewStartIso: "Nuovo inizio ISO",
      coWeekdayPrompt: "Giorno settimana (0=Dom … 6=Sab)",
      coStartTime: "Inizio (HH:MM)", coEndTime: "Fine (HH:MM)",
      coLoadingCheckIns: "Caricamento verifiche…", coRequest: "Richiedi",
      coReviewRespond: "Revisiona e rispondi", coNoNotes: "Nessuna nota",
      coSignals: "Segnali deterministici", coPreviousCheck: "Verifica precedente",
      coPrivateMedia: "Media privati", coCoachResponse: "Risposta coach",
      coSaveReview: "Salva revisione e rispondi",
      coNoSignals: "Nessun segnale deterministico rilevato.",
      coResponsePlaceholder: "Risposta operativa all’atleta…",
      coWriteResponse: "Scrivi una risposta al cliente",
      coCheckInReviewed: "Verifica revisionata",
      coCheckInRequested: "Verifica richiesta",
      coLoadingAnalytics: "Caricamento analisi…",
      coAthleteQuality: "Qualità atleta", coDaysShort: "g",
      coFilterClient: "Filtra per ID cliente (vuoto = portfolio)",
      coLoadingLedger: "Caricamento registro…", coManualLedger: "Registro manuale",
      coRules: "Regole", coAutomationName: "Nome automazione",
      coAutomationDefault: "Verifica ricevuta → task",
      coAutomationFailed: "Automazione fallita → task creato",
      coAutomationRan: "Automazione eseguita", coDryRunPrefix: "Prova a secco:",
      coAssistiveMedia: "Media assistivi", coVideoForm: "Video tecnica",
      coClientId: "ID cliente", coProteinG: "Proteine g",
      coCarbsG: "Carboidrati g", coFatsG: "Grassi g", coExercise: "Esercizio",
      coMarkersHint: "Marker (es. 0:12 ginocchio in valgo; 0:28 profondità)",
      coCoachFeedback: "Feedback coach", coEstimatePrefix: "Stima",
      coKcal: "kcal", coConfidence: "affidabilità",
      coReviewSaved: "Revisione salvata",
      coAgentPlaceholder: "Es. mostra i clienti inattivi, proponi un deload, crea un task…",
      coPlanSteps: "Piano: capisci → anteprima → conferma",
      coAgentLocal: "Agente in anteprima locale · conferma disabilitata",
      coGoodMorning: "Buongiorno", coGoodAfternoon: "Buon pomeriggio",
      coGoodEvening: "Buonasera", coNurvanAgent: "Agente Nurvan",
      coAttEnd: "Fine rapporto", coAttEndDetail: "ha chiesto di uscire",
      coAttAwaiting: "In attesa di te",
      coAttAwaitingDetail: "ha una richiesta da approvare",
      coAttUnread: "Messaggi non letti", coAttPayment: "Pagamento",
      coAttPaymentDetail: "non risulta pagato",
      coAttInactive: "Inattivo 7+ giorni",
      coAttLastWorkout: "Ultimo allenamento", coAttLiveNow: "In allenamento ora",
      coPlaceholderReady: "La struttura è pronta. I dati e le azioni compariranno quando la funzione sarà abilitata.",
      coPlaceholderSoon: "Questa sezione verrà attivata nella fase dedicata.",
      coSwitchClient: "Cambia cliente", coNotifications: "Notifiche",
      coCoachMenu: "Menu Coach", coLanguageUpdated: "Lingua aggiornata",
      coOsImportProgram: "COACH OS · IMPORTA PROGRAMMA",
      coOsPrograms: "COACH OS · PROGRAMMI",
      coPreviewCorrection: "ANTEPRIMA E CORREZIONE",
      coDocumentReview: "REVISIONE DOCUMENTO",
      coProvenance: "PROVENIENZA",
      coSaveCoachDb: "SALVA NEL COACH DATABASE",
      coImportHintEn: "Carica → estrazione → anteprima → scegli i domini → validazione → database coach / cliente.",
      coDomainWorkout: "Allenamento", coDomainTherapy: "Terapia",
      coDomainExams: "Esami", coDomainIntegration: "Integrazione",
      coMenuCoach: "Menu Coach", coClientList: "Lista clienti",
      coMyDatabase: "Il mio database", coClientSheet: "Scheda cliente",
      coChat: "Chat", coSaveEdits: "Salva modifiche",
      coBackToSheet: "Torna alla scheda",
      coNoClientOpen: "Nessun cliente aperto. Apri dalla lista.",
      coClientNotifyNow: "Notifiche cliente · ora",
      coOpenClientCalendar: "Apri un cliente per il suo calendario",
      coStaleProposal: "Questa proposta non è più aggiornata perché i dati sono cambiati."
    },
    en: {
      ...
      coPrimaryAction: "Primary action", coAskPlanExecute: "Ask. Plan. Execute.",
      coOnlineCoaching: "Online coaching", coSchedule: "Schedule",
      coScheduleHint: "Call, check-in and review.",
      coTodaySubtitle: "Priorities, clients and next actions in one place.",
      coNoUrgency: "Nothing urgent. The portfolio is under control.",
      coNoUrgencyWhy: "No client needs immediate attention right now.",
      coNoTasks: "Operational tasks will appear here.", coNoActivity: "No recent activity.",
      coNoTasksWhy: "Add a task to keep track of what's next.",
      coNoActivityWhy: "Your clients' recent actions will show up here.",
      coAddTask: "Add task", coAddClient: "Add client", coImportProgram: "Import program",
      coAssignProgram: "Assign program", coOpenAndCheck: "Coach OS · open and review",
      coKpiClients: "Clients", coKpiActive: "Active", coKpiUnread: "Unread", coKpiLive: "Live",
      coComplete: "Complete", coSnooze: "Snooze 1 day", coMoveUp: "Up", coMoveDown: "Down",
      coOpenClient: "Open client", coClose: "Close", coResolve: "Resolve", coTask: "Task",
      coAttention: "Attention", coLoadingPriorities: "Loading priorities…",
      coToastToday: "Coach OS · Today", coRequiresAttention: "Needs attention", coActivity: "Activity",
      coAllClients: "All clients", coSearchClients: "Search clients…", coSaveView: "Save view",
      coLoadMore: "Load more", coLoadingClients: "Loading clients…",
      coFilterAll: "All", coFilterActive: "Active", coFilterAttention: "Attention",
      coFilterInactive: "Inactive", coFilterUnread: "Unread", coFilterCheckin: "Check-ins",
      coFilterPayment: "Payments", coFilterProgram: "Program", coFilterNutrition: "Nutrition",
      coFilterInjury: "Injury",
      coStatusOnTrack: "On track", coStatusAtRisk: "At risk", coStatusAwaiting: "Awaiting coach",
      coStatusPayment: "Payment due", coNoWorkout: "No workout",
      coWorkoutToday: "Workout today", coWorkoutYesterday: "Workout yesterday",
      coNextAction: "Next action", coOpen: "Open", coMessage: "Message",
      coAthleteSnapshot: "Athlete snapshot", coAthleteIntelligence: "Athlete intelligence",
      coAthleteBrain: "Athlete Brain", coApprove: "Approve", coModify: "Modify",
      coDismiss: "Dismiss", coAskAgent: "Ask Agent", coOpenData: "Open data",
      coTimeline: "Timeline", coViewAll: "View all", coDomains: "Domains",
      coWeight: "Weight", coAdherence: "Adherence", coTraining: "Training",
      coPerformance: "Performance", coLast28d: "Last 28 days", coNoProgram: "No program",
      coTonnageTrend: "Tonnage trend", coGoalUnset: "Goal not set",
      coNoTimeline: "No significant activity yet.", coReviewClient: "Review client",
      coSavedAtRisk: "At Risk", coSavedNoWorkout: "No Workout 7d",
      coSavedCheckIns: "Check-ins", coSavedPayments: "Payments", coSavedNew: "New Clients",
      coInboxSubtitle: "Messages, check-ins, requests and attention. 1:1 chat stays the thread.",
      coSearchInbox: "Search messages or clients", coPreviewBroadcast: "Preview broadcast",
      coInboxEmpty: "Inbox empty. E2E threads stay in Chat.", coPin: "Pin", coUnpin: "Unpin",
      coProgramsSubtitle: "Import, create and assign programs without leaving Coach.",
      coSmartImport: "Smart import", coImportProgramTitle: "Import program",
      coImportHint: "PDF, Excel, Word, images. Always pick the domains.",
      coCreateProgram: "Create program", coCreateHint: "Nurvan catalog or rules-based generation.",
      coCoachDatabase: "Coach database", coAssign: "Assign", coWeeks: "weeks",
      coDomainPlan: "Domain plan",
      coCalendarSubtitle: "Availability → booking → reminder → reschedule/cancel.",
      coNewSession: "New session", coAvailability: "Availability",
      coSessionTypes: "Session types", coUpcoming: "Upcoming",
      coReschedule: "Reschedule", coCancel: "Cancel",
      coNoSessions: "No sessions in this view. Set availability and book a call.",
      coNoSessionsWhy: "You have no sessions scheduled today.",
      coNoAvailability: "No availability. Set hours before booking.",
      coTypeCall: "Coaching Call", coTypeCheckIn: "Check-in", coTypeReview: "Review",
      coTypeConsult: "Consultation", coTypeCustom: "Custom Session", coTypeTraining: "Training Session",
      coDay: "Day", coWeek: "Week", coMonth: "Month",
      coCheckInsSubtitle: "Requested, received and to review",
      coRequested: "Requested", coReceived: "Received", coToReview: "To review", coReviewed: "Reviewed",
      coNoCheckIns: "No check-ins in this queue.", coRequestCheckIn: "Request check-in",
      coAnalyticsSubtitle: "Adherence, workouts and check-ins. No revenue or MRR here.",
      coNoRevenue: "No revenue or MRR here.", coAtRisk: "At risk", coWorkouts: "Workouts",
      coE1rm: "e1RM samples", coVolume: "Volume", coCheckInsDue: "Check-ins due",
      coClientsToOpen: "Clients to open", coNoAtRisk: "No clients below threshold. Open Clients for details.",
      coBusinessSubtitle: "No Stripe. Plan, renewal and overdue.",
      coActive: "Active", coRevenue30d: "Revenue 30d", coOverdue: "Overdue",
      coCrmEmpty: "No clients in the pipeline.",
      coAutomationsSubtitle: "Trigger, condition, action. Dry-run before enabling.",
      coNewRule: "New rule", coDryRun: "Dry run", coRun: "Run",
      coNoAutomations: "No automations. They stay outside Agent V1.",
      coMealSubtitle: "Photo → Estimate → Confirm → Log. AI does not save without confirmation.",
      coMealEstimate: "Meal estimate", coEstimate: "Estimate", coConfirmLog: "Confirm & log",
      coFormSubtitle: "Video → Markers → Feedback → Exercise history. No clinical diagnosis.",
      coSaveMarkers: "Save markers", coAgentSubtitle: "Intent → Plan → Preview → Confirmation → Result.",
      coAskNurvan: "Ask Nurvan", coConfirm: "Confirm", coUndo: "Undo",
      coRefreshData: "Refresh data", coReplan: "Re-plan", coViewData: "View data",
      coAgentEmpty: "Ask a restricted command: inactive, missing check-ins, deload, message or task.",
      coIntent: "Intent", coPreview: "Preview", coResult: "Result",
      coWhy: "WHY",
      coHelpToast: "Coach OS guide: Today → Attention → Client → Decide → Execute",
      coCancel: "Cancel",
      coCoachMode: "Coach mode", coClientFallback: "Client", coUnread: "unread",
      coLiveWorkout: "Live workout", coClientsUnavailable: "Clients unavailable",
      coRetry: "Retry", coNoClientsView: "No clients for this view.",
      coClientFilter: "Client filter", coDaysAgo: "d ago",
      coLoadingOverview: "Loading client overview…", coLoadingOps: "Loading client operations…",
      coOverviewUnavailable: "Overview unavailable", coOpenClassic: "Open classic workspace",
      coBackOverview: "← Client overview", coDeterministic: "Deterministic",
      coNoRisks: "No deterministic risk detected. Open data for details.",
      coSaveViewPrompt: "Saved view name", coViewSaved: "View saved",
      coViewNotSaved: "View not saved", coOperational: "Operational",
      coLoadingInbox: "Loading inbox…", coPinned: "pinned",
      coBroadcastIds: "Client IDs to include in the preview (comma)",
      coBroadcastResult: "Broadcast preview. No message sent. Recipients:",
      coProgramBuilder: "Program builder", coProgramsCount: "programs",
      coProgramEmpty: "The database is empty. Import the first program and pick the domains.",
      coChooseClient: "Choose the client", coAddClientFirst: "Add a client first.",
      coProgramActions: "Program actions", coDuplicate: "Duplicate", coExport: "Export",
      coArchive: "Archive", coImportComplete: "Import complete",
      coProgramSaved: "Program saved",
      coAssignNow: "is in the coach database. Assign it now?",
      coAssignToClient: "Assign to client", coDone: "Done",
      coCopySuffix: " · Copy", coArchiveConfirm: "Archive this program?",
      coLoadingCalendar: "Loading calendar…",
      coNoCalendarHint: "No Google/Apple Calendar.",
      coIcal: "iCal", coRule: "Rule", coSessionTitle: "Session title",
      coSessionType: "Type", coStartIso: "Start ISO (e.g. 2026-09-06T09:00:00.000Z)",
      coRecurrenceWeeks: "Repeat weeks (1 = once)",
      coNewStartIso: "New start ISO",
      coWeekdayPrompt: "Weekday (0=Sun … 6=Sat)",
      coStartTime: "Start (HH:MM)", coEndTime: "End (HH:MM)",
      coLoadingCheckIns: "Loading check-ins…", coRequest: "Request",
      coReviewRespond: "Review and respond", coNoNotes: "No notes",
      coSignals: "Deterministic signals", coPreviousCheck: "Previous check",
      coPrivateMedia: "Private media", coCoachResponse: "Coach response",
      coSaveReview: "Save review and respond",
      coNoSignals: "No deterministic signal detected.",
      coResponsePlaceholder: "Operational reply to the athlete…",
      coWriteResponse: "Write a reply to the client",
      coCheckInReviewed: "Check-in reviewed",
      coCheckInRequested: "Check-in requested",
      coLoadingAnalytics: "Loading coach analytics…",
      coAthleteQuality: "Athlete quality", coDaysShort: "d",
      coFilterClient: "Filter by client ID (empty = portfolio)",
      coLoadingLedger: "Loading ledger…", coManualLedger: "Manual ledger",
      coRules: "Rules", coAutomationName: "Automation name",
      coAutomationDefault: "Check-in received → task",
      coAutomationFailed: "Automation failed → task created",
      coAutomationRan: "Automation ran", coDryRunPrefix: "Dry run:",
      coAssistiveMedia: "Assistive media", coVideoForm: "Video form",
      coClientId: "Client ID", coProteinG: "Protein g",
      coCarbsG: "Carbs g", coFatsG: "Fats g", coExercise: "Exercise",
      coMarkersHint: "Markers (e.g. 0:12 knee valgus; 0:28 depth)",
      coCoachFeedback: "Coach feedback", coEstimatePrefix: "Estimate",
      coKcal: "kcal", coConfidence: "confidence",
      coReviewSaved: "Review saved",
      coAgentPlaceholder: "E.g. show inactive clients, propose a deload, create a task…",
      coPlanSteps: "Plan: understand → preview → confirm",
      coAgentLocal: "Agent in local preview · confirm disabled",
      coGoodMorning: "Good morning", coGoodAfternoon: "Good afternoon",
      coGoodEvening: "Good evening", coNurvanAgent: "Nurvan Agent",
      coAttEnd: "End of relationship", coAttEndDetail: "asked to leave",
      coAttAwaiting: "Waiting on you",
      coAttAwaitingDetail: "has a request to approve",
      coAttUnread: "Unread messages", coAttPayment: "Payment",
      coAttPaymentDetail: "is not marked as paid",
      coAttInactive: "Inactive 7+ days",
      coAttLastWorkout: "Last workout", coAttLiveNow: "Training now",
      coPlaceholderReady: "The structure is ready. Data and actions appear when the feature is enabled.",
      coPlaceholderSoon: "This section will be enabled in its dedicated phase.",
      coSwitchClient: "Switch client", coNotifications: "Notifications",
      coCoachMenu: "Coach menu", coLanguageUpdated: "Language updated",
      coOsImportProgram: "COACH OS · IMPORT PROGRAM",
      coOsPrograms: "COACH OS · PROGRAMS",
      coPreviewCorrection: "PREVIEW & CORRECTION",
      coDocumentReview: "DOCUMENT REVIEW",
      coProvenance: "PROVENANCE",
      coSaveCoachDb: "SAVE TO COACH DATABASE",
      coImportHintEn: "Upload → extraction → preview → domain picker → validation → Coach database / client.",
      coDomainWorkout: "Workout", coDomainTherapy: "Therapy",
      coDomainExams: "Exams", coDomainIntegration: "Integration",
      coMenuCoach: "Coach menu", coClientList: "Client list",
      coMyDatabase: "My database", coClientSheet: "Client sheet",
      coChat: "Chat", coSaveEdits: "Save changes",
      coBackToSheet: "Back to sheet",
      coNoClientOpen: "No client open. Open one from the list.",
      coClientNotifyNow: "Client notifications · now",
      coOpenClientCalendar: "Open a client for their calendar",
  ...
  Object.keys(packs).forEach(function (lang) {
    if (service.dictionaries[lang]) Object.assign(service.dictionaries[lang], packs[lang]);
  });
})(I18nService);
