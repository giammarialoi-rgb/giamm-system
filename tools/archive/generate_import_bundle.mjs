...
const raw = fs.readFileSync('universal-import-engine.mjs', 'utf8');
...
async function confirmImportAndActivate() {
  ...
  try {
    ...
    if (prog.duration_weeks && typeof store !== 'undefined' && store.prefs) {
...
fs.writeFileSync('prepare_task20_import_engine.mjs', clean + '\n\n' + reviewCallbacks, 'utf8');
console.log('✅ prepare_task20_import_engine.mjs generated successfully as raw JS with buildCanonicalProgram!');
