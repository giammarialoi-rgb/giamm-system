...
const fns = ['addSetToExercise', 'removeSetFromExercise', 'updateData', 'toggleSetDone', 'rirToRpe', 'rpeToRir', 'toggleIntensityType', 'startTimer', 'stopTimer'];
fns.forEach(fn => {
  console.log(`=== ${fn} ===`);
  console.log(extractFunction(fn));
});
