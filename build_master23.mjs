...
console.log('=== MASTER BUILD 23: PHYSICAL VALIDATION BUGFIX & BUNDLE COMPILATION ===');
      ...
      const ConfigService = {
        getCoachApiUrl() {
          if (typeof NativeConfig !== 'undefined' && NativeConfig.getCoachApiUrl) {
            return NativeConfig.getCoachApiUrl();
          }
          return CONFIG.coachApiUrl;
        },
        getGoogleClientId() {
          if (typeof NativeConfig !== 'undefined' && NativeConfig.getGoogleClientId) {
            return NativeConfig.getGoogleClientId();
          }
          return CONFIG.googleClientId;
        },
        getConfig() { return { ...CONFIG }; },
        isConfigured() {
          const url = this.getCoachApiUrl();
