...
const startMarker = 'const ProgramService = {';
const endMarker = 'const WorkoutService = {';
...
`;
  ...
  code = code.substring(0, startIdx) + newProgramService + code.substring(endIdx);
  fs.writeFileSync('build_master24.mjs', code, 'utf8');
  console.log('✓ Successfully updated ProgramService in build_master24.mjs');
} else {
  console.error('Markers not found in build_master24.mjs');
}
