...
window.openMealPhotoPicker = typeof openMealPhotoPicker !== 'undefined' ? openMealPhotoPicker : (() => {});
window.startMealPhotoCapture = typeof startMealPhotoCapture !== 'undefined' ? startMealPhotoCapture : (() => {});
window.handleMealPhotoSelected = typeof handleMealPhotoSelected !== 'undefined' ? handleMealPhotoSelected : (() => {});
window.closeMealPhotoModal = typeof closeMealPhotoModal !== 'undefined' ? closeMealPhotoModal : (() => {});
window.confirmMealPhotoInsert = typeof confirmMealPhotoInsert !== 'undefined' ? confirmMealPhotoInsert : (() => {});
window.addMealPhotoDraftRow = typeof addMealPhotoDraftRow !== 'undefined' ? addMealPhotoDraftRow : (() => {});
window.removeMealPhotoDraftRow = typeof removeMealPhotoDraftRow !== 'undefined' ? removeMealPhotoDraftRow : (() => {});
window.insertFoodsIntoSelectedMeal = typeof insertFoodsIntoSelectedMeal !== 'undefined' ? insertFoodsIntoSelectedMeal : (() => {});
...
// The page's switchPlan only says there is no in-app purchase; plans come from the server.
window.switchPlan = typeof switchPlan !== 'undefined' ? switchPlan : (() => {});
...
// Plans and features: web/features.json is the only list; the page reads it
// as self.NURVAN_FEATURES from this generated file (the server reads the JSON).
fs.writeFileSync('web/features.js', '// Generated by build_master25.mjs from web/features.json. Do not edit.\nself.NURVAN_FEATURES = ' + JSON.stringify(JSON.parse(fs.readFileSync('web/features.json', 'utf8'))) + ';\n', 'utf8');
